...
void loop() {
  ...
  okunandeger1 = map(okunandeger1, 0, 1023, 145  , 175);     // joistik den gelen 0 ila 1023 arasındakı degeri 0 ila 60 a orantılıyoruz.
  ...
  okunandeger2 = map(okunandeger2, 0, 1023, 35, 65);     
